        ...
        <section class="row">
            <div class="card">
                ...
                <div class="card-body mt-3t">
                    <form class="form" action="{{ route('store.vendor') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row">
                             <div class="col-md-6 col-12 mt-3">
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                        ...
                                        placeholder="PT. N" name="name" value="{{ old('name') }}">
                            ...
                            <div class="col-md-6 col-12 mt-3">
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                        ...
                                        placeholder="https://cth.com" name="website" value="{{ old('website') }}">
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control form-control-lg @error('address') is-invalid @enderror" name="address" id="address" placeholder="Jl. Kebon Jeruk">{{old('address')}}</textarea>
