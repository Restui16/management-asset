        ...
        <section class="row">
            <div class="card">
                ...
                <div class="card-body mt-3t">
                    <form class="form" action="{{ route('store.asset') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="col-md-6 col-12 mt-3">
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                        ...
                                        placeholder="Asset Name" name="name" value="{{ old('name') }}">
                            ...
                            <div class="col-md-6 col-12 mt-3">
                                ...
                                <div class="form-group">
                                    <select class="form-select select2 @error('category_asset_id') is-invalid @enderror"
                                        ...
                                        <option value="{{ $category->id }}" {{ old('category_asset_id') !=''
                                            ? 'selected' : '' }}>
                            ...
                            <div class="col-md-6 col-12 mt-3">
                                ...
                                <div class="form-group ">
                                    <select class="form-select select2 @error('vendor_id') is-invalid @enderror"
                                        ...
                                        <option value="{{ $vendor->id }}" {{ old('vendor_id') !='' ? 'selected' : '' }}>
                                            {{ $vendor->name }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-6 col-12 mt-3">
                                ...
                                <div class="form-group">
                                    <select class="form-select select2 @error('condition') is-invalid @enderror"
                                        ...
                                        <option value="not bad" {{ old('condition') == 'not bad' ? 'selected' : ''}}>Not Bad</option>
                            ...
                            <div class="col-md-6 col-12 mt-3">
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                        ...
                                        placeholder="8500000" name="price" value="{{ old('price') }}">
                            ...
                            <div class="col-md-6 col-12 mt-3">
                                <div class="form-group">
                                    ...
                                    <input type="date"
                                        ...
                                        name="purchase_date" placeholder="0812xxxx" value="{{ old('purchase_date') }}">
                            ...
                            <div class="col-md-6 col-12 mt-3">
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                        ...
                                        placeholder="25334xxxx" name="serial_number" value="{{ old('serial_number') }}">
                            ...
                            <div class="col-md-6 col-12 mt-3">
                                <div class="form-group">
                                    ...
                                    <textarea
                                        ...
                                        name="description" id="description" placeholder="spesifikasi">{{ old('description')}}</textarea>
